...
<div class="main-wrap">
	...
	<div class="result-wrap">
		<form action="<?php echo U('Dividend/updateCofig');?>" method="post" id="myform"
					...
					<table width="100%" class="insert-tab">
						<tbody>
							<tr>
								...
								<td>
									<select name="dividend_id">
										...
										<?php if(is_array($currency)): $i = 0; $__LIST__ = $currency;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['currency_id']); ?>" <?php if(($config["dividend_id"]) == $vo["currency_id"]): ?>selected<?php endif; ?>><?php echo ($vo['currency_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
							...
							<tr>
								...
								<td><input type="text" id="" value="<?php echo ($config["num1"]); ?>"
									size="85" name="num1" class="common-text"></td>
							</tr>
							<tr>
								<th><i class="require-red">*</i><?php echo ($config["num1"]); ?>---发行量(万)：<br/>
									<i class="require-red">*</i>达到分红条件交易金额：<br/>
									<i class="require-red">*</i>每日做多获得奖励数：<br/>
									<i class="require-red">*</i>达到条件获得分红股数量（个）
								</th>
								<td><input type="text" id="" value="<?php echo ($config["num2"]); ?>"
									size="85" name="num2" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["money1"]); ?>"
									size="85" name="money1" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["max1"]); ?>"
									size="85" name="max1" class="common-text"><span style="color:red;">如果用户当日获得币数大于最大获得数量业绩也不会增加</span>
									<br/>
									<input type="text" id="" value="<?php echo ($config["get1"]); ?>"
									size="85" name="get1" class="common-text">
								</td>
							</tr>
							<tr>
								<th><i class="require-red">*</i><?php echo ($config["num2"]); ?>(万)---发行量(万)：<br/>
									<i class="require-red">*</i>达到分红条件交易金额：<br/>
									<i class="require-red">*</i>每日做多获得奖励数：<br/>
									<i class="require-red">*</i>达到条件获得分红股数量（个）
								</th>
								<td><input type="text" id="" value="<?php echo ($config["num3"]); ?>"
									size="85" name="num3" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["money2"]); ?>"
									size="85" name="money2" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["max2"]); ?>"
									size="85" name="max2" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["get2"]); ?>"
									size="85" name="get2" class="common-text">
								</td>
							</tr>
							<tr>
								<th><i class="require-red">*</i><?php echo ($config["num3"]); ?>(万)---发行量(万)：<br/>
									<i class="require-red">*</i>达到分红条件交易金额：<br/>
									<i class="require-red">*</i>每日做多获得奖励数：<br/>
									<i class="require-red">*</i>达到条件获得分红股数量（个）
								</th>
								<td><input type="text" id="" value="<?php echo ($config["num4"]); ?>"
									size="85" name="num4" class="common-text">
									<span style="color:red;">如果发行量超过系统设置发行量不会获得任何分红</span>
									<br/>
									<input type="text" id="" value="<?php echo ($config["money3"]); ?>"
									size="85" name="money3" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["max3"]); ?>"
									size="85" name="max3" class="common-text"><br/>
									<input type="text" id="" value="<?php echo ($config["get3"]); ?>"
