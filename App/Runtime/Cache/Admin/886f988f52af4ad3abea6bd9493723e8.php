...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">添加分红奖励</span></div>
    </div>
    ...
    <div style="float:left; width:30%; margin-right:20px;">
        ...
        <form action="<?php echo U('Bonus/addBonus');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
	...
	<table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                           <td><?php echo (getCurrencynameByCurrency($vo["currency_id"])); ?></td>
                            <td><?php echo ((isset($vo['sumMoney']) && ($vo['sumMoney'] !== ""))?($vo['sumMoney']):0); ?></td>
							<td><?php echo ((isset($vo['money']) && ($vo['money'] !== ""))?($vo['money']):0); ?></td>
                           <td><?php if($vo['sumMoney'] - $vo['money'] < 0): ?>0<?php else: ?> <?php echo ($vo['sumMoney'] - $vo['money']); endif; ?>  </td>
